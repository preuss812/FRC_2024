...
public class BalanceCommandDebugDH extends CommandBase {
  ...
  public BalanceCommandDebugDH(final DriveTrain subsystem, final GyroSubsystem gyro, final EncoderSubsystem encoder, final BrakeSubsystem brake) {
